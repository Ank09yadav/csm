...
import {
  ...
  KeyboardAvoidingView, ScrollView, Platform, TextInput, BackHandler
} from 'react-native';
  ...
  return (
    ...
    >
      ...
      <View style={[styles.subHeader, { paddingTop: insets.top }]}>
        <Text style={styles.subHeaderText}>Poetry Room</Text>
      </View>
      ...
      >
        ...
        <View style={styles.sentMessage}>
          <Text style={styles.sentMessageText}>Hi! I can this works perfectly.</Text>
        </View>
      </ScrollView>
